...
using CIS_420_WebApplication.Areas.Identity.Pages.Account.Manage;
...
namespace CIS_420_WebApplication.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new CIS_420_WebApplication.Models.ApplicationUser {
                ...
                if (result.Succeeded)
                {
                    ...
                    return Redirect(HtmlEncoder.Default.Encode( Url.Page("/Account/Manage/Index")));
                }
